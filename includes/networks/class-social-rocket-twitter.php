...
class Social_Rocket_Twitter {
	...
	public function __construct() {
		...
		$this->color_bg_hover     = '#0d0d0d';
		$this->color_border       = '#0d0d0d';
		$this->color_border_hover = '#1a1a1a';
		$this->cta                = __( 'Post', 'social-rocket' );
		$this->key                = 'twitter';
		$this->icon_class         = 'fab fa-x-twitter';
		$this->share_url          = 'https://x.com/intent/tweet?text=%tweet%&url=%url%';
